...
def build_h5(dataset, train_or_test, t, video_root_path=data_path):
...
def combine_dataset(dataset, t, video_root_path='/share/data/videos'):
    ...
    for n, f in enumerate(tqdm(filelist)):
      ...
      if n == 0:
        ...
        create_dataset = output_file.create_dataset('data', (total_rows, t, 227, 227, 1), maxshape=(None, t, 224, 224, 1))
...
def preprocess_data(logger, dataset, t, video_root_path='/share/data/videos'):
    ...
    mean_frame_file = os.path.join(video_root_path, dataset, 'mean_frame_227.npy')
    ...
    if not os.path.isfile(mean_frame_file):
        ...
        processing.pixel_mean(dataset, video_root_path)
    ...
    try:
        ...
        processing.image_normalization(dataset, video_root_path)
